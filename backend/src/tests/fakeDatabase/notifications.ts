...
export const fakeNotifications = [
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439011'),
    userId: fakeUserDatabase[1]?._id || '',
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439012'),
    userId: fakeUserDatabase[1]?._id || '',
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439013'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439014'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],
    title: '4 - Nova tarefa',
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439015'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439016'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439017'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439018'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd799439019'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],
    title: '9 - Sentença publicada',
    message: 'A sentença do processo "Execução de Sentença Trabalhista" foi publicada no sistema.',
    isRead: false,
    metadata: {
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd79943901a'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],
  ...
  {
    _id: Types.ObjectId.createFromHexString('507f1f77bcf86cd79943901b'),
    userId: fakeUserDatabase[1]?._id || '',
    type: NotificationType.CREATED,
    channels: ['IN_APP'],

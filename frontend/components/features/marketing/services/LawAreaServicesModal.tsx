...
export function LawAreaServicesModal() {
  ...
  return (
    isOpen && (
      <div
        className={`flex z-9999 fixed left-[50%] translate-x-[-50%] top-[10vh] w-[90%] min-md:w-[60%] min-lg:w-[496px] h-fit rounded-xl shadow-soft overflow-hidden bg-color-white text-color-black fade-in-animation`}
      >

    ...
    <footer>
      <div className="flex flex-col h-[50vh] bg-color-primary">
        <div className="flex justify-center items-center h-[65%]">
          <img className="size-[240px]" src="website-logo.webp" alt="" loading="lazy" />
        </div>
        <div className="flex justify-center items-center gap-[24px] lg:gap-[16px] h-[15%] border-y border-color-secondary">
          <a href="#">
            <img className="size-[40px]" src="icons/instagram.svg" alt="" loading="lazy" />
          </a>
          <a href="#">
            <img className="size-[40px]" src="icons/facebook.png" alt="" loading="lazy" />
          </a>
        </div>

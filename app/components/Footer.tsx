    ...
    <footer>
      <div className="flex flex-col h-[50vh] bg-color-primary">
        <div className="flex justify-center items-center h-[65%]">
          <img className="size-[240px] lg:size-[160px]" src="website-logo.webp" alt="" />
        </div>
        <div className="flex justify-center items-center gap-[24px] lg:gap-[16px] h-[15%] border-y border-color-secondary">
          <a href="#">
            <img className="size-[40px] lg:size-[24px]" src="icons/instagram.svg" alt="" />
          </a>
          <a href="#">
            <img className="size-[40px] lg:size-[24px]" src="icons/facebook.png" alt="" />
          </a>
        </div>
